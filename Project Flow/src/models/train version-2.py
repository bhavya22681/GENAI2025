...
def load_data(path):
    """C:/Users/royal/OneDrive/Desktop/Downloads/Sample - Superstore .xls"""
    return pd.read_excel("C:/Users/royal/OneDrive/Desktop/Downloads/Sample - Superstore .xls")
...
def main():
    data_path = "C:/Users/royal/OneDrive/Desktop/Downloads/Sample - Superstore .xls"  # Update path if needed
    features = [
        'Sales',
        'Quantity',
        'Discount',
    ...
    df['Sales by Discount'] = df['Sales'] * df['Discount']
    df['Ship Date - Order Date'] = (pd.to_datetime(df['Ship Date']) - pd.to_datetime(df['Order Date'])).dt.days
